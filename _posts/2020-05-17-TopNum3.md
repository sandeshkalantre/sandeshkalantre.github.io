...
For example, consider solutions to \\( 19 x - 7 y \\), whose continued fraction representation we have computed before. One of the covergents is \\( 8/3 \\). Hence, our required general solution is \\( (x,y) = (3 + 7 k, 8 + 19 k) \\). 
