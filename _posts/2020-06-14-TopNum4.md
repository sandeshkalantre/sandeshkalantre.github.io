...
3. \\(T(x/y) = -y/x \\) with matrix \\( \begin{pmatrix}0 & 1 \\\\ -1 & 0 \end{pmatrix} \\). This is a composition of 1 and 2 (changing the order adds an overall minus sign to the matrix).  
